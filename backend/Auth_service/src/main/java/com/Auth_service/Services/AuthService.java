...
import com.Auth_service.util.RequestHandler;
...
public class AuthService {
    ...
    public ResponseEntity<RegisterCheckResponce> registerUser(UserCred request) {
    ...
    public ResponseEntity<UserDBResponse> forgotPassword(String email, String username) {
       return requestHandler.forgotPassword(email,username);
    }
}
